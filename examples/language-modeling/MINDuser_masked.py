...
#     VERSION = datasets.Version("0.1.0")
    ...
    def _split_generators(self, dl_manager):
        ...
        downloaded_files = {'train': '/scratch/jx880/capstone/transformers/examples/language-modeling/data/masked/masked/train_user_entities.txt',
                             'dev': '/scratch/jx880/capstone/transformers/examples/language-modeling/data/masked/masked/dev_user_entities.txt',
